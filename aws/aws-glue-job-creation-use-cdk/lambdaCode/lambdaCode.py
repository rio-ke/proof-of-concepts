...
def getJobDetails():
    jobStatus = glueModule.list_jobs()
    return jobStatus['JobNames']
    
# EXECUTION STARING POINT
def lambda_handler(event, context):
    # Set GLUE_ROLE_NAME to lambda environmental variable role_name, shard with  glueRoleDefine
    ...
    MaxConcurrentRuns = jsonData['glueJobsProperty'][0][glueJobName]['MaxConcurrentRuns']
    
    list = getJobDetails()
    if searchJob(list, glueJobName):
