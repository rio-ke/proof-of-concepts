...
resource "aws_lambda_function" "lambdaResource" {
...
resource "aws_api_gateway_integration" "lambda" {
  ...
  type                    = "AWS_PROXY"
  uri                     = aws_lambda_function.lambdaResource.invoke_arn
}
...
resource "aws_lambda_permission" "apigw" {
  ...
  function_name = aws_lambda_function.lambdaResource.function_name
