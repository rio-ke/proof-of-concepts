...
class muitiPartUpload(object):
    ...
    def __init__(self,bucket,key,local_path,part_size=int(15e6),profile_name=None,region_name="eu-west-1",verbose=False):
...
def main():
    mpu = muitiPartUpload("secret-jn", "mediacreationtool.exe",
                            "/home/operation-unknown/Documents/demo/mediacreationtool.exe", profile_name="default",  region_name="ap-southeast-1")
